...
| `web/` | The page: `app.html` shell, `app.css`, `js/*.js` (plain scripts sharing one scope, inlined at build) |
...
Lint, formatting, types and tests (run `npm install` once first). Python: `ruff check . && ruff format --check .`.
